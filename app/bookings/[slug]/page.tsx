...
import { getActiveBusinessBySlug } from "@/lib/business/data";
...
export default async function BusinessPublicPage({
  ...
  // Only slugs that have cleared moderation (slug_status = 'active') are public.
  // Pending or rejected slugs return 404, same as a non-existent business.
