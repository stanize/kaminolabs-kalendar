...
const DEFAULT_LABELS: PatientLabels = {
  ...
  roleConfirmBodySuffix: "ya existe como cuenta de clínica. No es posible añadir el acceso de cliente a esta cuenta por tu cuenta. Si necesitas ambos tipos de acceso, contacta con soporte.",
